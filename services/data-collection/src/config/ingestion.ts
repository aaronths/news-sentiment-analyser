...
// The default number of pages to fetch per source. Only non-API sources with
// explicit pagination support (like Guardian) honor this.
export const DEFAULT_INGEST_PAGES = 50;
