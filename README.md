...
- currently includes The Guardian, ABC, SBS, and New York Times
...
- uses local mock file storage by default
- uploads both files to S3 only when `NEWS_DATA_STORAGE_MODE=s3` and `NEWS_DATA_BUCKET` is configured
